...
import styles from './stylescontact.css'
...
function Masonry() {
    ...
    return (<div id={"delivery"}>
        <div className={"text-before-img"}>Працюємо по всій Україні</div>
        <div ref={ref} className='list' style={{ height: Math.max(...heights) }}>qwert
